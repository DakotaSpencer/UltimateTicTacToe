...
public class PlayerVComp {
    ...
    public static void main() {
        ...
        //while(i<9)
        {
            ...
            {
                if(getWinner(players[1].getColour() + "COMPUTER" + ANSI_RESET + " turn", board, players[1]))
                {
                    foundWinner=1;
                    board.printBoard();
                    System.out.println(players[1].getColour() + "COMPUTER" + ANSI_RESET + " WINS");
                    System.exit(1);
                    break;
                }
                board.printBoard();
    ...
    public static void colorMenu(Player [] players) {
        ...
        System.out.println(ANSI_RED + "PLAYER " +ANSI_RESET + "VS" + ANSI_BLUE + " COMPUTER" + ANSI_RESET);
